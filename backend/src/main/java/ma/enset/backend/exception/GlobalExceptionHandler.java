...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotWritable(HttpMessageNotWritableException ex,
                                                           WebRequest request) {
        log.error("JSON serialization failed: {}", ex.getMostSpecificCause().getMessage(), ex);
        return ResponseEntity
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ErrorResponse.of("SERIALIZATION_ERROR",
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex, WebRequest request) {
        ...
        log.error("Unexpected error: {}", root.getMessage(), ex);
        return ResponseEntity
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
